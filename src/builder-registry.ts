...
Builder.registerComponent(TechnologiesHeroSection, {
     ...
     inputs: [
          ...
          },
          {
               ...
               type: 'string',
               defaultValue:
                    'We use the latest technologies to build your applications',
          },
          {
               name: 'image',
               type: 'file',
               defaultValue:
                    'https://accedia.com/wp-content/2023/08/Untitled-design-67.png',
          },
          {
               name: 'imageAlt',
               type: 'string',
...
Builder.registerComponent(TechnologiesPartnerSection, {
     ...
     inputs: [
          ...
          },
          {
               ...
               type: 'file',
               defaultValue:
                    'https://www.accedia.com/wp-content/uploads/2022/03/Maria-in-a-meeting-scaled.jpg',
          },
          {
               name: 'whyUsReasons',
               type: 'list',
               ...
               defaultValue: [
                    {
                         label: 'A highly skilled team of 250+ consultants with diverse expertise deliver proven solutions across industries.',
                    },
                    {
                    ...
                    {
                         label: 'Certified for Quality Management (ISO 9001:2015), Information Security Management (ISO/IEC 27001:2013), and Environmental Management (ISO 14001:2015).',
                    },
               ],
          },
     ],
