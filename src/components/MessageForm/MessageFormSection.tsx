...
export default function MessageFormSection(props: IProps) {
  ...
  const { sectionTitle, subtitle, linkText, inputFields, termsAndConditionsText, buttonText } = props;
  ...
  return (
    <div className={isWindow ? styles.wrapperWindow : styles.wrapperMobile}>
      <div className={styles.left}>
        ...
        <div className={styles.contactInfoWrapper}>
          ...
          <div className={styles.info}>
            ...
            <p className={styles.infoTxt}>Bulgaria: +359 (2) 444 20 03 US: +1 (650) 521 51 56</p>
          </div>
        </div>
      </div>
      <div className={styles.right}>
        {inputFields?.map((f, i) => (
          <InputField key={i} f={f} focused={focused} i={i} setFocused={setFocused} />
        ))}
